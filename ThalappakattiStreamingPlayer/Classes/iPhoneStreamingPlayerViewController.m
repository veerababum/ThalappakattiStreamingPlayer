...
//		autorelease];
    ...
    [(NSString *)CFURLCreateStringByAddingPercentEscapes(
                                                         nil,
                                                         (CFStringRef)@"http://54.254.141.206:32011",
                                                         NULL,
                                                         NULL,
                                                         kCFStringEncodingUTF8)
     autorelease];
...
- (void)viewDidLoad
{
    ...
    downloadSourceField.hidden = YES;
...
//    UIImageView *backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"offer_gradient"]];
//    backgroundView.frame = self.view.bounds;
//    [[self view] addSubview:backgroundView];
    CGRect screenBounds = [[UIScreen mainScreen] bounds];
    if (screenBounds.size.height == 568) {
        // code for 4-inch screen
        self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"background568"]];
